...
- Generated at: 2026-06-01T03:53:31.420595+00:00
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| 100 | 0.760 | 0.770 | 0.970 | 1.000 | 0.970 | 93.71 | 1 |

- Unsupported article numbers: None
- Unretrieved citations: None
- Graph expansion used: 90 queries
- Average graph depth: 2.171
...
| direct_qa | 19 | 1.000 | 1.000 | 1.000 | 1.000 | 100.00 |
| document_guidance_qa | 10 | 1.000 | 1.000 | 1.000 | 1.000 | 100.00 |
| exception_based_qa | 11 | 1.000 | 1.000 | 1.000 | 1.000 | 100.00 |
| hard_negative_citation_qa | 5 | 0.200 | 1.000 | 1.000 | 0.200 | 77.50 |
| labor_dispute_procedure_qa | 5 | 0.000 | 0.800 | 1.000 | 0.000 | 78.26 |
| multi_hop_qa | 7 | 0.286 | 1.000 | 1.000 | 0.286 | 81.52 |
| out_of_corpus_qa | 6 | 1.000 | 0.833 | 1.000 | 0.833 | 97.13 |
| paraphrased_real_user_qa | 5 | 0.000 | 1.000 | 1.000 | 0.000 | 68.50 |
...
| bao ve thai san khi lam dem lam them | 1 | 0.000 | 1.000 | 1.000 | 1.000 | 0.000 | 66.25 |
...
| hoa giai truoc khi kien | 2 | 1.000 | 1.000 | 1.000 | 1.000 | 1.000 | 100.00 |
...
| khau tru tien luong va boi thuong thiet hai | 1 | 0.000 | 1.000 | 1.000 | 1.000 | 0.000 | 77.50 |
...
| ngoai pham vi corpus - xu phat hanh chinh | 1 | 1.000 | 0.000 | 1.000 | 0.000 | 0.000 | 82.81 |
...
| tranh chap don phuong cham dut hop dong trai phap luat | 1 | 0.000 | 0.000 | 1.000 | 0.000 | 0.000 | 72.88 |
| tranh chap lao dong | 2 | 1.000 | 1.000 | 1.000 | 1.000 | 1.000 | 100.00 |
| tranh chap nguoi giup viec gia dinh | 1 | 0.000 | 1.000 | 1.000 | 1.000 | 0.000 | 77.50 |
| tranh chap tien luong va tham quyen toa an | 1 | 0.000 | 1.000 | 1.000 | 1.000 | 0.000 | 83.12 |
| tranh chap tro cap mat viec lam | 1 | 0.000 | 1.000 | 1.000 | 1.000 | 0.000 | 91.56 |
...
| tuoi nghi huu | 4 | 1.000 | 1.000 | 1.000 | 1.000 | 1.000 | 100.00 |
| xu ly ky luat lao dong | 1 | 0.000 | 1.000 | 1.000 | 1.000 | 0.000 | 83.12 |
| yeu cau tuyen bo thoa uoc lao dong tap the vo hieu | 1 | 0.000 | 1.000 | 1.000 | 1.000 | 0.000 | 66.25 |
...
| hard | 46 | 0.630 | 0.935 | 1.000 | 0.935 | 0.609 | 89.99 |
| medium | 38 | 0.868 | 1.000 | 1.000 | 1.000 | 0.868 | 96.45 |

## Graph-Required Results

| Requires graph | Queries | Retrieval pass | Answer pass | Citation pass | Quality pass | E2E pass | Avg quality |
| --- | --- | --- | --- | --- | --- | --- | --- |
| False | 57 | 0.895 | 0.982 | 1.000 | 0.982 | 0.877 | 96.74 |
| True | 43 | 0.605 | 0.953 | 1.000 | 0.953 | 0.605 | 89.70 |
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| False | 61 | 0.885 | 0.984 | 1.000 | 0.984 | 0.869 | 96.21 |
| True | 39 | 0.590 | 0.949 | 1.000 | 0.949 | 0.590 | 89.79 |
...
| retirement_age_general | document_guidance_qa | tuoi nghi huu | hard | Pass | 1.00 | Pass | Pass | 100.00 | None |
...
| labor_dispute_limitation | direct_qa | tranh chap lao dong | medium | Pass | 1.00 | Pass | Pass | 100.00 | None |
...
| guidance_dismissal_dispute | document_guidance_qa | hoa giai truoc khi kien | hard | Pass | 1.00 | Pass | Pass | 100.00 | None |
...
| robust_ooc_admin_fine_late_salary | out_of_corpus_qa | ngoai pham vi corpus - xu phat hanh chinh | hard | Fail | 1.00 | Pass | Fail | 82.81 | answer_missing_required_rule |
...
| robust_user_salary_deduction_damage | paraphrased_real_user_qa | khau tru tien luong va boi thuong thiet hai | medium | Fail | 0.33 | Pass | Pass | 77.50 | retrieval_missing_required_context |
...
| robust_user_pregnant_night_overtime | paraphrased_real_user_qa | bao ve thai san khi lam dem lam them | medium | Fail | 0.00 | Pass | Pass | 66.25 | retrieval_missing_required_context |
...
| robust_dispute_unlawful_termination_court | labor_dispute_procedure_qa | tranh chap don phuong cham dut hop dong trai phap luat | hard | Fail | 0.40 | Pass | Fail | 72.88 | retrieval_missing_required_context, answer_missing_required_rule, low_information_answer |
| robust_dispute_salary_deduction_court_choice | labor_dispute_procedure_qa | tranh chap tien luong va tham quyen toa an | hard | Fail | 0.50 | Pass | Pass | 83.12 | retrieval_missing_required_context |
| robust_dispute_job_loss_allowance_no_mediation | labor_dispute_procedure_qa | tranh chap tro cap mat viec lam | hard | Fail | 0.75 | Pass | Pass | 91.56 | retrieval_missing_required_context |
| robust_dispute_domestic_worker_no_mediation | labor_dispute_procedure_qa | tranh chap nguoi giup viec gia dinh | hard | Fail | 0.33 | Pass | Pass | 77.50 | retrieval_missing_required_context |
| robust_dispute_collective_agreement_invalid_request | labor_dispute_procedure_qa | yeu cau tuyen bo thoa uoc lao dong tap the vo hieu | hard | Fail | 0.00 | Pass | Pass | 66.25 | retrieval_missing_required_context |
...
- `robust_user_salary_deduction_damage`: retrieval_missing_required_context
  Query: Toi lam hong dung cu, cong ty tru luong hang thang toi gan het luong thi co duoc khong?
  Missing required citations: BLLD Dieu 102 khoan 3, BLLD Dieu 129 khoan 1
  Citation issues: None
...
- `robust_user_wedding_paid_leave`: retrieval_missing_required_context
  ...
  Citation issues: None
- `robust_user_pregnant_night_overtime`: retrieval_missing_required_context
  Query: Toi dang mang thai thang thu bay ma cong ty van xep ca dem va tang ca, co dung luat khong?
  Missing required citations: BLLD Dieu 137 khoan 1
  Citation issues: None
...
- `robust_dispute_unlawful_termination_court`: retrieval_missing_required_context, answer_missing_required_rule, low_information_answer
  ...
  Missing required citations: BLLD Dieu 188, BLTTDS Dieu 32 khoan 1 diem a, BLTTDS Dieu 40 khoan 1 diem d
  Citation issues: None
- `robust_dispute_salary_deduction_court_choice`: retrieval_missing_required_context
  Query: Cong ty khau tru luong qua muc, toi muon kien thi tranh chap tien luong nay co thuoc Toa an va toi co the chon Toa noi toi cu tru hoac lam viec khong?
  Missing required citations: BLLD Dieu 102, BLTTDS Dieu 40 khoan 1 diem d
  Citation issues: None
- `robust_dispute_job_loss_allowance_no_mediation`: retrieval_missing_required_context
  Query: Bi cat giam nhan su do thay doi co cau ma cong ty khong tra tro cap mat viec, toi co can hoa giai truoc khi kien khong?
  Missing required citations: BLTTDS Dieu 32 khoan 1 diem b
  Citation issues: None
- `robust_dispute_domestic_worker_no_mediation`: retrieval_missing_required_context
  Query: Nguoi giup viec gia dinh bi chu nha cham dut hop dong va no luong thi tranh chap nay co can hoa giai truoc khi ra Toa khong?
  Missing required citations: BLLD Dieu 162, BLTTDS Dieu 32 khoan 1 diem c
  Citation issues: None
- `robust_dispute_collective_agreement_invalid_request`: retrieval_missing_required_context
  Query: Muon yeu cau tuyen bo thoa uoc lao dong tap the vo hieu thi can can cu Bo luat Lao dong va BLTTDS dieu nao?
  Missing required citations: BLLD Dieu 86, BLLD Dieu 87, BLTTDS Dieu 33 khoan 1, BLTTDS Dieu 35 khoan 2 diem d
  Citation issues: None

## Answer Generation Failures

- `robust_ooc_admin_fine_late_salary`: answer_missing_required_rule
  Query: Cong ty cham tra luong bi phat hanh chinh bao nhieu tien?
  Citation issues: None
...
| low_information_answer | 2 |
| retrieval_missing_required_context | 21 |
