...
export default function AdminSettingsPage() {
  return (
    <AppPageShell
      actions={<Button>Lưu cấu hình</Button>}
      description="Cấu hình chế độ trả lời, citation, streaming, retrieval và ngôn ngữ giao diện."
        ...
        <section className="rounded-lg border border-border bg-surface p-5 shadow-sm">
          ...
          <div className="grid gap-5">
            ...
            <div className="grid gap-3 sm:grid-cols-2">
              ...
              <ToggleRow icon={Bell} label="Phản hồi trực tiếp" value="Bật" />
              <ToggleRow icon={Moon} label="Giao diện tối" value="Theo thiết bị" />
              <ToggleRow icon={Languages} label="Ngôn ngữ" value="Tiếng Việt" />
            </div>
          </div>
        </section>
